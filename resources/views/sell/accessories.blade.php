...
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-8 col-xl-9">
            ...
            <a href="{{ route('accessoriesStats') }}" class="btn color-bg text-light mb-3 ml-2 lg:ml-12 mt-1 inline-block">Statystyki</a>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-3 col-xl-3">
            <form class="inline-block relative mt-4 mb-2 ml-2 lg:pl-12 lg:ml-12" action="{{ route('sellAccessoriesResults') }}" method="POST">
                @csrf
